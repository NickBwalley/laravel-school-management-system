...
<div class="w-full max-w-xs mx-auto">
    <form method="POST" action="{{ route('login') }}" class="bg-gray-400 shadow rounded px-8 pt-6 pb-8 mb-4">
        @csrf
        <div class="mb-4">
        ...
        <div class="flex items-center justify-between">
            <button class="bg-green-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">
                Sign In
            </button>
        </div>
    </form>
